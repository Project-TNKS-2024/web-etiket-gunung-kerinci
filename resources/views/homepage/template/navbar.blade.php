            ...
            <ul class="navbar-nav me-auto mb-2 py-2 mb-sm-0 d-flex align-items-center">
                <li class="nav-item">
                    <a href="{{ route('homepage.beranda') }}"
                        class="nav-link py-2 py-sm-0 px-2 text-white rounded-4 mx-2">Beranda</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('homepage.panduan') }}"
                        class="nav-link py-2 py-sm-0 px-2 text-white rounded-4 mx-2">Panduan Pemesanan</a>
                </li>
                <li class="nav-item">
