...
@section('main')
    <div class="position-relative overflow-hidden text-center bg-body-tertiary">
        <div class="col-md-8 p-lg-5 mx-auto my-5">
            ...
            <div
                class="gk-bg-base-white w-100 mt-5 rounded-pill p-2 px-3  d-flex align-items-center justify-content-between">
                ...
                <div class="my-0">
                    <button
                        class="my-0 btn btn-sm border-0 btn-primary gk-bg-primary700 gk-text-base-white rounded-pill">Booking
                        Online</button>
                </div>
            </div>
        </div>
                ...
                @for ($i = 1; $i <= 6; $i++)
                    <div class="col-12 col-md-6 col-lg-4 mb-3">
                        <div class="card h-100 rounded" style="max-height: 256px; position: relative; overflow:hidden;">
                            <img src="{{ asset('assets/img/cover/document-xx.png') }}" class="rounded berita-img"
                                alt="Jalur Pendakian Kersik Tuo"
                                style="object-fit: cover; max-height: fit-content; height: 100%;"></img>
                            <div class="overlay rounded"></div> <!-- Dark overlay -->
                            <div class="card-body rounded gk-text-base-white d-flex flex-column justify-content-end h-100"
