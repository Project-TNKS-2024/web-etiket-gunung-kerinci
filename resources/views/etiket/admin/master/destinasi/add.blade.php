...
@section('main')
<a class="btn btn-secondary w-fit text-start mb-3" href="{{route('admin.master.destinasi')}}">
...
<div class="card">
   <div class="card-header ">
      <h5 class="mb-0"><b>Tambah Destinasi</b></h5>
   </div>
   <div class="card-body">
      <form action="{{ route('admin.master.destinasi.addAction')}}" method="POST">
         ...
         <div class="row">
            ...
            <!-- Detail -->
            <div class="form-group col-12 mb-3">
               <label class="form-label" for="detail">Detail Destinasi</label>
