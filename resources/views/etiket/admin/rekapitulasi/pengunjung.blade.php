...
<div class="card mb-4">
   ...
   <div class="card-body">
      <form action="{{ route('admin.rekap.pengunjung') }}" method="GET" class="row g-3 filter-form">
         <div class="col-md-4">
         ...
         <div class="col-md-2">
            ...
            <a href="{{ route('admin.rekap.pengunjung.download', request()->query()) }}" target="_blank" class="btn btn-success w-100">Download</a>
         </div>
      </form>
   </div>
</div>
...
<div class="card">
   <div class="card-header">
      <h5 class="mb-0"><b>Pengunjung</b></h5>
      <div class="d-flex justify-content-between">
         <p class="mb-0">{{ $rentang_awal->format('d M Y') }} - {{ $rentang_akhir->format('d M Y') }}</p>
         <p class="mb-0 text-black fw-bold">{{ $total_kunjugan }} Kunjungan</p>
      </div>
   </div>
   <div class="card-body">
         ...
         <table class="table table-bordered table-hover" id="table-pendapatan">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>{{ $d->total_pendaki_wni }}</td>
                  <td>{{ $d->total_pendaki_wna }}</td>
