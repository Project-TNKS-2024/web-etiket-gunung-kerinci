...
<div class="card">
   ...
   <div class="card-body">
      <form method="post" action="{{route('admin.profile.action')}}" enctype="multipart/form-data">
         @csrf
         <div class="row">
            <!-- First Name -->
            ...
            <div class="form-group col-12 iptFile-input">
               ...
               <div class="input-group flex-nowrap">
                  <input class="form-control border-secondary" data-size="0.5" type="file" style="min-width:87px;" name="lampiran_identitas" id="lampiran_identitas" accept="image/*,.pdf">

                  @if (isset($user->biodata) && isset($user->biodata->lampiran_identitas) && file_exists(public_path($user->biodata->lampiran_identitas)))
                  <label for="lampiran_identitas" class="form-control text-secondary border-secondary w-100" id="label_lampiran_identitas_existing">
                     {{ basename($user->biodata->lampiran_identitas) }}
                  </label>
...
<div class="card">
   <div class="card-body py-3">
      <a href="{{route('admin.profile.resetPassword')}}" class="btn btn-warning">Ganti Password</a>
   </div>
</div>
