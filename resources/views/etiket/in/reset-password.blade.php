...
@section('main')
    <div class="p-4 my-4 d-flex xl-my-5 xl-py-5 justify-content-center align-items-center" style="">
        <script>
        ...
        <form
            class=" border form h-full d-flex flex-column justify-content-center reset-form shadow px-4 rounded-2xl text-center"
            method="POST" id="resetForm" action="{{ route('etiket.in.actionresetpassword') }}">
            @csrf
        ...
        <div class="border form h-full flex-column align-items-center justify-content-center reset-form shadow px-4 rounded-2xl text-center d-none"
