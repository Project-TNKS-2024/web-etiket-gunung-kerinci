...
<div class="col py-5 px-4 my-5 my-md-0" style="min-height: 700px; overflow-y: auto;">
    ...
    <div class="row gap-3 px-2">
        <div class="col-sm-12 col-md-12 col-lg-5 col-xl-3 col-12 text-sm p-2 rounded py-3 d-flex gap-3"
            style="border: 1px solid var(--neutrals300)">
    ...
    <div class="d-flex gap-5 px-3" style="width:120vh; overflow-x: auto;">
        @foreach ($booking as $book)
        <div class="row col-5 col-sm-12 col-md-12 col-lg-12 col-xl-6 rounded-2xl card ticket px-4 p-sm-4 p-md-5 pt-md-3 pt-3"
            style="padding-bottom: 30px; padding-right: 30px;">
            <div class="row align-items-center gap-2 font-semibold">Status <div class="{{$book->status_pembayaran ? "
                    gk-bg-success200" : "gk-bg-warning200" }} rounded-md px-4 py-2 font-bold"
                    style="width: fit-content">{{$book->status_pembayaran ? "Aktif" : "Belum Bayar"}}</div>
            </div>
