...
<body>
    <div style="">
        ...
        <div>
            Silahkan klik tombol berikut <a href="http://localhost:8000/reset-password/{{ $token }}"
        ...
        <div>
            <a
                href="http://localhost:8000/reset-password/{{ $token }}">http://localhost:8000/reset-password/{{ $token }}</a>
        </div>
    </div>
</body>
