                ...
                <form id="checkpoint-form" action="{{ route('admin.checkpoint.tambahAction') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12">
                            ...
                            <textarea name="deskripsi_naik" id="lokasi-deskripsi" class="form-control bg-white borderx" style="min-height: 75px;" placeholder="Deskripsi Checkpoint naik"></textarea>
                        </div>
                        <div class="col-md-5 col-sm-12">
                            <label class="form-label">Deskripsi Saat Turun</label>
                            <textarea name="deskripsi_turun" id="lokasi-deskripsi" class="form-control bg-white borderx" style="min-height: 75px;" placeholder="Deskripsi Checkpoint turun"></textarea>
                        </div>
                    </div>
                    <div class="row">
