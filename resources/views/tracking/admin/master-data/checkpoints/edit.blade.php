                ...
                <form id="checkpoint-form" action="{{ route('admin.checkpoint.editAction', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <textarea name="deskripsi" id="lokasi-deskripsi" class="form-control bg-white borderx" style="min-height: 75px;" placeholder="Deskripsi Checkpoint">{{$data->deskripsi}}</textarea>
                        </div>
                    </div>
                    <div class="row">
